        ...
        public override void AtaqueFichaLimpio(Tablero table)
        {
            ...
            for (i= 0; i < 8; i++)
            {
                ...
                {contador = 0;
                    ...
                    for (int k = 0; k < 8; k++) //Copiamos la matriz original a la auxiliar
                    {
                        for (int l = 0; l < 8; l++)
                        {
                    ...
                    if ((NB == false && (i + j) % 2 == 0) || (NB==true && (i+j)%2!=0))
                    {
        ...
        public override Tablero AtaqueFicha(Tablero table)
        {
            ...
            for (i = 0; i < 8; i++)
            {
                for (j = 0; j < 8; j++) //Se coloca la ficha en posicion
                {
                    ...
                    if ((NB == false && (i + j) % 2 == 0) || (NB == true && (i + j) % 2 != 0)) //Verifica que un alfil vaya a casillas pares y otro a impares
                    {
                        for (k = -8; k < 8; k++) //Se cubren casillas diagonales
                        {
